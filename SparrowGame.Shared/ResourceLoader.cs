...
namespace SparrowGame.Shared
{
    ...
    {
        private const string ASSEMBLY_NAME = "SparrowGame.";
        //		/// <summary>
        ...
        {
        	return GetEmbeddedResourceStream (Assembly.GetCallingAssembly(), ASSEMBLY_NAME + resourceFileName);
        }
        //
        //		/// <summary>
        //		/// Attempts to find and return the given resource from within the calling assembly.
        ...
        {
        	return GetEmbeddedResourceBytes(Assembly.GetCallingAssembly(), ASSEMBLY_NAME + resourceFileName);
        }
        //
        //		/// <summary>
        //		/// Attempts to find and return the given resource from within the calling assembly.
        ...
        {
        	return GetEmbeddedResourceString(Assembly.GetCallingAssembly(), ASSEMBLY_NAME + resourceFileName);
        }
        ...
        public static void _DebugPrintAllResources()
        {
            foreach (var s in typeof(ResourceLoader).Assembly.GetManifestResourceNames())
            {
